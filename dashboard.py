...
# ====================================================================
# LIVE WORKSPACE INTERACTIVE FILTERS
# ====================================================================
st.markdown("### 🔍 WORKSPACE SEARCH & FILTERS")
c_f1, c_f2, c_f3 = st.columns(3)

with c_f1:
    search_do = st.text_input("Search Outgoing DO Number", placeholder="Type DO number to look up...")
with c_f2:
    if not df_dispatch.empty and "Warehouse_Name" in df_dispatch.columns:
        ...
        wh_options = ["All"]
    wh_filter = st.selectbox("Filter Warehouse Hub", wh_options)
with c_f3:
    status_filter = st.selectbox("Filter Queue Status", ["All", "Pending", "Dispatched", "Return"])

# Apply Pipeline Filtering
