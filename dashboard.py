...
# 1. We define the credentials, but we DO NOT use a PEM parser. 
# We use the raw client_email and the project_id directly.
creds_dict = {
...
# 2. Connect using the dictionary
try:
    gc = gspread.service_account_from_dict(creds_dict)
    # Open the file
    sh = gc.open_by_key("1nfD90CqHeb0TFSbivR9_rvoBlECJ37FgA5j-2G2Eyzc")
