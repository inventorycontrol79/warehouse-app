...
# We represent the private key as a single clean string without manual breaks
...
# Constructing the dictionary locally to avoid any Streamlit Secrets interference
creds = {
